...
const navbarBackground = navTop ? "" : "bg-extra4-100 drop-shadow"
 ...
 return(
<nav>
<div className={`${navbarBackground} ${flexBetween} bg-primary4 fixed top-0 z-30 w-full py-6`}>
...
<div className="fixed right-0 bottom-0 z-40 h-full w-[300px] bg-primary4 drop-shadow-xl" >
